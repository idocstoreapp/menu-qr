    ...
    <div className="space-y-6">
      ...
      {isFormOpen && (
        <div className="fixed inset-0 bg-black/70 flex items-center justify-center p-4 z-50">
          <div className="bg-arabic-dark border-2 border-gold-600 rounded-xl p-6 w-full max-w-md">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-arabic-brown border border-gold-600 rounded-lg px-4 py-2 text-gold-100 focus:outline-none focus:border-gold-400 font-mono text-sm"
